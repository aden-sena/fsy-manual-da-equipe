function Jantar() {
    return(
        <>
            ...
            <p>Caso você seja o coordenador assistente responsável por supervisionar as refeições, ajude a manter os jovens em uma área limitada. Os demais coordenadores assistentes que foram designados para ajudar devem chegar 30 minutos mais cedo e se apresentarem a você.</p>
        </>
    )
}
